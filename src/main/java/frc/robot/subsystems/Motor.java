...
public class Motor extends TalonFX {
        ...
        sysIdRoutine =
            new SysIdRoutine(
                new SysIdRoutine.Config(
                    ...
                    (state) -> Logger.recordOutput("Motors/SysId/" + super.getDescription(), state.toString())),
                new SysIdRoutine.Mechanism(
                    (voltage) -> super.setControl(control.withOutput(voltage.in(Volts))), null, subsystem));
    }
    ...
    /**
     * Run the all SysId routines in sequence for this motor, including both quasistatic and dynamic tests in both directions.
     */
